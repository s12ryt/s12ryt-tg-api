...
function recordSchedulerFire(timerId, note) {
...
const BOT_COMMANDS = ["/plugin_example", "/my_usage", "/plugin_data"];
...
const plugin = {
  ...
  setup(context) {
    ...
    services.storage.set("setupCount", (services.storage.get("setupCount") ?? 0) + 1);
